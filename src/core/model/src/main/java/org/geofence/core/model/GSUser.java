...
@Table(
        ...
        uniqueConstraints = {
            @UniqueConstraint(columnNames = "extid", name = "gf_gsuser_extid_key"),
            @UniqueConstraint(columnNames = "name", name = "gf_gsuser_name_key")
        })
...
public class GSUser implements Identifiable, Serializable {
    ...
    @JoinTable(
            ...
            inverseForeignKey = @ForeignKey(name = "fk_uug_group")) // @JoinTable
    @Column(name = "u_id")
