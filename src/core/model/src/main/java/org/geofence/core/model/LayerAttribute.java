...
public class LayerAttribute implements Serializable, Cloneable {
     ...
     *
     * <p>This field should be notnull, but making it so, hibernate will insist to put it into the PK. We'll making it
     * notnull in the {@link LayerDetails#attributes parent class}, but this seems not to work. We're enforncing the
     * notnull at the DAO level.
     */
