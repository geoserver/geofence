...
public interface AdminRuleAdminService {
    ...
    //     *
    //     * @param page used for retrieving paged data, may be null if not used. If not null, also <TT>entries</TT>
    // should be defined.
    //     * @param entries used for retrieving paged data, may be null if not used. If not null, also <TT>page</TT>
    // should be defined.
    //     *
    //     * @see RuleReaderService#getMatchingRules(String, String, String,  String,String, String,String)
     ...
     * Return the Rules according to the filter.
     *
     * @param page used for retrieving paged data, may be null if not used. If not null, also <TT>entries</TT> should be
     *     defined.
     * @param entries used for retrieving paged data, may be null if not used. If not null, also <TT>page</TT> should be
     *     defined.
    ...
    /**
     * Return the Rules according to the filter. Rules will be enriched with all their joined data, so this method may
     * be heavy to execute.
     *
     * @param page used for retrieving paged data, may be null if not used. If not null, also <TT>entries</TT> should be
     *     defined.
