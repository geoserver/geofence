...
public interface RuleAdminService {
    ...
    /**
     * Return the Rules according to the priority.Returns the rules having priority greater or equal to <code>priority
     * </code>
     *
    ...
    /**
     * Return the Rules according to the filter.Rules will be enriched with all their joined data, so this method may be
     * heavy to execute.
     *
     * @param page used for retrieving paged data, may be null if not used. If not null, also <TT>entries</TT> should be
     *     defined.
