...
public class RuleReaderServiceImpl_GeomTest extends ServiceTestBase {
    ...
    public void testRuleLimitsAllowedAreaReprojectionWithDifferentSrid() throws NotFoundServiceEx, ParseException {
        ...
        try {
            ...
            // save limits and check it has been saved
            {
                RuleLimits limits = new RuleLimits();
                String wkt =
                        "MultiPolygon (((1680529.71478682174347341 4849746.00902365241199732, 1682436.7076464940328151 4849731.7422441728413105, 1682446.21883281995542347 4849208.62699576932936907, 1680524.95919364970177412 4849279.96089325752109289, 1680529.71478682174347341 4849746.00902365241199732)))";
                Geometry allowedArea = new WKTReader().read(wkt);
            ...
            // save limits and check it has been saved
            {
                RuleLimits limits = new RuleLimits();
                String wkt =
                        "MultiPolygon (((680588.67850254673976451 4850060.34823693986982107, 681482.71827003755606711 4850469.32878803834319115, 682633.56349697941914201 4849499.20374245755374432, 680588.67850254673976451 4850060.34823693986982107)))";
                Geometry allowedArea = new WKTReader().read(wkt);
    ...
    public void testRuleSpatialFilterTypeClipSameGroup() throws ParseException {
        ...
        ruleAdminService.insert(
                new Rule(9999, null, null, null, null, "s11", "r11", null, "w11", "l11", GrantType.ALLOW));
        long id = ruleAdminService.insert(
                new Rule(10, user.getName(), "group11", null, null, "s11", "r11", null, "w11", "l11", GrantType.LIMIT));
        RuleLimits limits = new RuleLimits();
        ...
        long id2 = ruleAdminService.insert(
                new Rule(11, user.getName(), "group12", null, null, "s11", "r11", null, "w11", "l11", GrantType.LIMIT));
    ...
    public void testRuleSpatialFilterTypeIntersectsSameGroup() throws ParseException {
        ...
        ruleAdminService.insert(
                new Rule(9999, null, null, null, null, "s11", "r11", null, "w11", "l11", GrantType.ALLOW));
        long id = ruleAdminService.insert(
                new Rule(13, user.getName(), "group13", null, null, "s11", "r11", null, "w11", "l11", GrantType.LIMIT));
        RuleLimits limits = new RuleLimits();
        ...
        long id2 = ruleAdminService.insert(
                new Rule(14, user.getName(), "group14", null, null, "s11", "r11", null, "w11", "l11", GrantType.LIMIT));
        RuleLimits limits2 = new RuleLimits();
        limits2.setSpatialFilterType(SpatialFilterType.INTERSECT);
        limits2.setCatalogMode(CatalogMode.HIDE);
        String areaWKT2 =
    ...
    public void testRuleSpatialFilterTypeEnlargeAccess() throws ParseException {
        ...
        ruleAdminService.insert(
                new Rule(999, null, null, null, null, "s22", "r22", null, "w22", "l22", GrantType.ALLOW));

        long id = ruleAdminService.insert(
                new Rule(15, null, "group22", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits = new RuleLimits();
        limits.setSpatialFilterType(SpatialFilterType.INTERSECT);
        limits.setCatalogMode(CatalogMode.HIDE);
        String areaWKT =
        ...
        long id2 = ruleAdminService.insert(
                new Rule(16, null, "group23", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits2 = new RuleLimits();
    ...
    public void testRuleSpatialFilterTypeFourRules() throws ParseException {
        ...
        long id = ruleAdminService.insert(
                new Rule(17, null, "group31", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits = new RuleLimits();
        limits.setSpatialFilterType(SpatialFilterType.INTERSECT);
        limits.setCatalogMode(CatalogMode.HIDE);
        String areaWKT =
        ...
        long id2 = ruleAdminService.insert(
                new Rule(18, null, "group31", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits2 = new RuleLimits();
        limits2.setSpatialFilterType(SpatialFilterType.CLIP);
        limits2.setCatalogMode(CatalogMode.HIDE);
        String areaWKT2 =
        ...
        long id3 = ruleAdminService.insert(
                new Rule(19, null, "group32", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        ...
        long id4 = ruleAdminService.insert(
                new Rule(20, null, "group32", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
    ...
    public void testRuleSpatialFilterTypeFourRules2() throws ParseException {
        ...
        long id = ruleAdminService.insert(
                new Rule(21, null, "group41", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits = new RuleLimits();
        limits.setSpatialFilterType(SpatialFilterType.CLIP);
        limits.setCatalogMode(CatalogMode.HIDE);
        String areaWKT =
        ...
        long id2 = ruleAdminService.insert(
                new Rule(22, null, "group41", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits2 = new RuleLimits();
        limits2.setSpatialFilterType(SpatialFilterType.CLIP);
        limits2.setCatalogMode(CatalogMode.HIDE);
        String areaWKT2 =
        ...
        long id3 = ruleAdminService.insert(
                new Rule(23, null, "group42", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits3 = new RuleLimits();
        ...
        long id4 = ruleAdminService.insert(
                new Rule(24, null, "group42", null, null, "s22", "r22", null, "w22", "l22", GrantType.LIMIT));
        RuleLimits limits4 = new RuleLimits();
