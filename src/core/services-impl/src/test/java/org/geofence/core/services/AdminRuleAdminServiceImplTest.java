...
public class AdminRuleAdminServiceImplTest extends ServiceTestBase {
    ...
    @Test
    public void testInsertDeleteAdminRule(TestInfo testInfo) throws NotFoundServiceEx {
        ...
        assertTrue(adminruleAdminService.delete(rule.getId()), "Could not delete rule");
    }
