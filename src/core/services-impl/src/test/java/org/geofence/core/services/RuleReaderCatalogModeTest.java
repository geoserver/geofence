...
public class RuleReaderCatalogModeTest extends ServiceTestBase {
    ...
    public void testCatalogModeOneNull() throws NotFoundServiceEx {
        ...
        insertRule(new Rule(20, "u1", null, null, null, null, null, null, null, "l1", GrantType.LIMIT), null);
        insertRule(
                new Rule(21, null, "g1", null, null, null, null, null, null, "l1", GrantType.ALLOW), CatalogMode.MIXED);
    ...
    public void testCatalogModeNoNull() throws NotFoundServiceEx {
        ...
        insertRule(
                new Rule(20, "u1", null, null, null, null, null, null, null, "l1", GrantType.LIMIT), CatalogMode.HIDE);
        insertRule(
                new Rule(21, null, "g1", null, null, null, null, null, null, "l1", GrantType.ALLOW), CatalogMode.MIXED);
    ...
    public void testCatalogModeTwoGroups() throws NotFoundServiceEx {
        ...
        insertRule(
                new Rule(20, null, "g2", null, null, null, null, null, null, "l1", GrantType.ALLOW), CatalogMode.HIDE);
        insertRule(
                new Rule(21, null, "g1", null, null, null, null, null, null, "l1", GrantType.ALLOW), CatalogMode.MIXED);
