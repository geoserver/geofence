...
import static org.geofence.core.db.dao.search.SearchUtil.*;
...
public class RuleDAOImpl extends PrioritizableDAOImpl<Rule> implements RuleDAO {
    ...
    @Override
    public void persist(Rule rule) throws DuplicateKeyException {
    ...
    protected Search<Rule> getDupSearch(Rule rule) {
        ...
        addSearchField(search, "validAfter", rule.getValidAfter());
        addSearchField(search, "validBefore", rule.getValidBefore());
