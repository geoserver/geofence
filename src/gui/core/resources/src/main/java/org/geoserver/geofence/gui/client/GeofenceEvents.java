...
public class GeofenceEvents {
    ...
    /** The Constant ATTACH_AOI_WIDGET. */
    ...
    /** The Constant ATTACH_GEOCONSTRAINT_AOI_WIDGET. */
    public static final EventType ATTACH_GEOCONSTRAINT_AOI_WIDGET = new EventType();

    /** The Constant ATTACH_GEOCONSTRAINT_MEMBER_WIDGET. */
    ...
    /** The Constant ATTACH_MEMBER_WIDGET. */
    public static final EventType ATTACH_MEMBER_WIDGET = new EventType();

    /** The Constant ATTACH_NODE_SELECTION_WIDGET. */
    ...
    /** The Constant ATTACH_WATCHES_WIDGET. */
    ...
    /** The Constant INJECT_WKT. */
    public static final EventType INJECT_WKT = new EventType();

    /** The Constant INJECT_WKT_FROM_SHP. */
