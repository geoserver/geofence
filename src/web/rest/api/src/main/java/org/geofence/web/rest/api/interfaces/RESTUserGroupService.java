...
public interface RESTUserGroupService {
    ...
    @Path("/name/{name}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    RESTOutputGroup get(@PathParam("name") String name) throws BadRequestRestEx, NotFoundRestEx, InternalErrorRestEx;

    @POST
    @Path("/")
    @Produces({MediaType.TEXT_PLAIN, MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    Response insert(@FormDataParam("userGroup") RESTInputGroup group)
    ...
    @Path("/name/{name}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    void update(@PathParam("name") String name, @FormDataParam("userGroup") RESTInputGroup group)
            throws BadRequestRestEx, NotFoundRestEx, InternalErrorRestEx;
    ...
    //            @QueryParam("cascade") @DefaultValue("false") boolean cascade) throws ConflictRestEx, NotFoundRestEx,
    // InternalErrorRestEx;
