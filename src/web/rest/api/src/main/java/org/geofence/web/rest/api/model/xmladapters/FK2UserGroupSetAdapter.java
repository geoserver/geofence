...
public class FK2UserGroupSetAdapter extends XmlAdapter<FK2UserGroupSetAdapter.GroupList, Set<RESTUserGroup>> {

    @Override
    public Set<RESTUserGroup> unmarshal(GroupList inSet) throws ParseException {
        if (inSet == null) return null;

        Set<RESTUserGroup> ret = new HashSet<>();
