...
public class RESTInputAdminRule extends AbstractRESTPayload {
    ...
    private RESTAdminGrantType grant;
    ...
    @XmlAttribute
    public RESTAdminGrantType getGrant() {
        return grant;
    }

    public void setGrant(RESTAdminGrantType grant) {
        this.grant = grant;
    }
    ...
    public String toString() {
        ...
        if (position != null && position.getPosition() != null) {
            if (position.getPosition() == RESTRulePosition.RESTPositionReference.fixedPriority) sb.append('=');
            else if (position.getPosition() == RESTRulePosition.RESTPositionReference.offsetFromTop) sb.append('+');
            else if (position.getPosition() == RESTRulePosition.RESTPositionReference.offsetFromBottom) sb.append('-');
